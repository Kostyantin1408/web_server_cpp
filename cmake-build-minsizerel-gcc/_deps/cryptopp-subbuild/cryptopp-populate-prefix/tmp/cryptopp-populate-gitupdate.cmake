...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "CRYPTOPP_8_8_0"
  WORKING_DIRECTORY "/Users/kostyantin/web_server_cpp/cmake-build-minsizerel-gcc/_deps/cryptopp-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/kostyantin/web_server_cpp/cmake-build-minsizerel-gcc/_deps/cryptopp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/kostyantin/web_server_cpp/cmake-build-minsizerel-gcc/_deps/cryptopp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
